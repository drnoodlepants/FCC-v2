...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, STATUS_LED_Pin|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_11
                          |DEBUG_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ENABLE_GPIO_Port, ENABLE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : STATUS_LED_Pin PC6 PC7 PC11
                           DEBUG_LED_Pin */
  GPIO_InitStruct.Pin = STATUS_LED_Pin|GPIO_PIN_6|GPIO_PIN_7|GPIO_PIN_11
                          |DEBUG_LED_Pin;
